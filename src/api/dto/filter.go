...
type Filter struct {
	// Type = contains, notContains, startsWith, endsWith, equals, notEqual, lessThan, lessThanOrEqual, greaterThan, greaterThanOrEqual, inRange ...
	Type       string `json:"type"`
	From       string `json:"from"`
	To         string `json:"to"`
	FilterType string `json:"filterType"` // text, number
}
